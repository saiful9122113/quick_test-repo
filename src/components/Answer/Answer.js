    ...
    return (
        <div>
            <div className='w-96 md:w-1/2 mx-auto text-left text-sm md:text-2xl my-10 shadow-2xl rounded-xl'>
                <h1 className='bg-green-600 text-lg md:text-4xl rounded-xl p-2'><strong><span>Question 01 :</span></strong> What is react perfrom of react Router?</h1>
            ...
            <div className='w-96 md:w-1/2 mx-auto text-left text-sm md:text-2xl my-10 shadow-2xl rounded-xl'>
                <h1 className='bg-green-600 text-lg md:text-4xl rounded-xl p-2'><strong><span>Question 02 : </span></strong>How does context API work? </h1>
            ...
            <div className='w-96 md:w-1/2 mx-auto text-left text-sm md:text-2xl my-10 shadow-2xl rounded-xl'>
                <h1 className='bg-green-600 text-lg md:text-4xl rounded-xl p-2'><strong><span>Question 03 : </span></strong>UseRef কী ? এটার কাজ কী? </h1>
